            ...
            steps {
                withCredentials([
                    ...
                    sshagent([SSH_CREDENTIALS_ID]) {
                        ...
                        sh "ssh $REMOTE_USER@$REMOTE_HOST ' docker pull samihosni/frontend-react:latest'"
                        sh "ssh $REMOTE_USER@$REMOTE_HOST ' docker pull samihosni/backend-flask:latest'"
                        sh "ssh $REMOTE_USER@$REMOTE_HOST ' docker pull samihosni/springboot-app:latest'"
